...
export function createLawyerBot(opts: BotOptions): Bot {
  ...
  bot.command('start', async (ctx) => {
    ...
    console.log(`[Lawyer Bot] /start from ${telegramId}, superadmin=${sa}, configSuperadminId=${superadminTelegramId}`);
